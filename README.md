...
You should use [`./script/install-pre-reqs`](./script/install-pre-reqs) to automatically install the required development tools and toolchains for Rust and Python. Execute that as:

...
mod tests {
    ...
    #[tokio::test]
    async fn test_update_file(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_update_file_on_empty_repo(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_empty_configured_remote_repo_test(kind, |local_repo, remote_repo| async move {
            let branch_name = "main";
            let directory_name = "test_data";
            let file_path = test::test_img_file();
            let commit_body = NewCommitBody {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_update_file_to_full_path(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
            |local_repo, remote_repo| async move {
                let branch_name = "main";
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_update_file_to_full_path_on_empty_repo(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_empty_configured_remote_repo_test(kind, |local_repo, remote_repo| async move {
            let branch_name = "main";
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_get_file(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_delete_file(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
            |local_repo, remote_repo| async move {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_delete_file_after_upload(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_get_file_with_workspace(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
            |local_repo, remote_repo| async move {
    ...
    #[tokio::test]
    #[cfg(feature = "ffmpeg")]
    async fn test_upload_video_and_get_thumbnail(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_empty_configured_remote_repo_test(kind, |_local_repo, remote_repo| async move {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_rm_directory(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
            |_local_repo, remote_repo| async move {

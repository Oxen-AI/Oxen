...
mod tests {
    ...
    #[tokio::test]
    async fn test_get_file_entry(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_get_dir_entry(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_get_remote_metadata(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
        test::run_training_data_fully_sync_remote(kind, |_local_repo, remote_repo| async move {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_latest_commit_by_branch(#[case] kind: MerkleStoreKind) -> Result<(), OxenError> {
        test::run_training_data_fully_sync_remote(kind, |local_repo, remote_repo| async move {

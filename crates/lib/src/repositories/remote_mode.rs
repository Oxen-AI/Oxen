...
mod tests {
    ...
    #[tokio::test]
    async fn test_remote_mode_clone_only_downloads_tree(
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_list_tabular_files(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            ...
            |local_repo, remote_repo| async move {
                ...
                test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let new_files = repositories::tree::list_tabular_files_in_repo(
                        &remote_mode_repo,
                        &new_head,
                    )?;
                    ...
                    let files = repositories::tree::list_tabular_files_in_repo(
                        &local_repo,
                        &local_repo_head,
                    )?;
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_merkle_two_files_same_hash(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
            |local_repo, remote_repo| async move {
                ...
                test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let status_opts =
                        StagedDataOpts::from_paths_remote_mode(&[p1.clone(), p2.clone()]);

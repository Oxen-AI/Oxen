...
mod tests {
    ...
    #[tokio::test]
    async fn test_remote_mode_add_file_with_full_path(
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_add_file_with_relative_path(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_add_file_with_canon_path(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_add_and_modify_file_in_new_subdir(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_add_multiple_files_in_sub_dir(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_add_files_with_glob_path(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_add_dir_recursive(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_cannot_add_if_not_modified(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,

...
mod tests {
    ...
    #[tokio::test]
    async fn test_remote_mode_rm_synced_file(
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_rm_unsynced_file(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_readme_remote_repo_test(kind, |_local_repo, remote_repo| async move {
            let remote_repo_copy = remote_repo.clone();
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_rm_unsynced_subdir_file(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_rm_unsynced_file_with_full_path(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_readme_remote_repo_test(kind, |_local_repo, remote_repo| async move {
            let remote_repo_copy = remote_repo.clone();
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_rm_staged_file(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_rm_one_file_in_dir(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_remote_repo_test_bounding_box_csv_pushed(
            kind,
            |_local_repo, remote_repo| async move {
                ...
                test::run_empty_dir_test_async(|dir| async move {
                    ...
                    .await?;
                    let commit_body =
                        NewCommitBody::from_config(&UserConfig::get()?, "Adding images");
                    ...
                    // Commit removal
                    let commit_body =
                        NewCommitBody::from_config(&UserConfig::get()?, "Removing file");
                    repositories::remote_mode::commit(&cloned_repo, &commit_body).await?;
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_rm_dir_with_asterisk(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
    ...
    #[case::lmdb(MerkleStoreKind::Lmdb)]
    #[tokio::test]
    async fn test_remote_mode_rm_dir_with_glob_path(
        #[case] kind: MerkleStoreKind,
    ) -> Result<(), OxenError> {
        test::run_training_data_fully_sync_remote(kind, |_local_repo, remote_repo| async move {
            let remote_repo_copy = remote_repo.clone();

...
where
    for<'a> <Self as MerkleWriter>::Session<'a>:
        WriteSession<'a, Error = <Self as MerkleReader>::Error>,
{
}
...
where
    ...
    for<'a> <T as MerkleWriter>::Session<'a>: WriteSession<'a, Error = <T as MerkleReader>::Error>,
{
}

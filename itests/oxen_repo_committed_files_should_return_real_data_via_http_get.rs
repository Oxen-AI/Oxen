...
async fn test_list_repositories_via_http_get() {
    ...
    loop {
        ...
        if body.contains("test_repo") {
            ...
            assert!(false, "Expected 'test_repo' in response after {} attempts: {}", max_attempts, body);
        } else {
...
async fn test_get_specific_repository_info() {
    ...
    let response = client.get(&format!("{}/api/repos/test_user/test_repo", server.base_url()))
        .send()
        .await
...
async fn test_list_files_in_repository() {
    ...
    let response = client.get(&format!("{}/api/repos/test_user/test_repo/files", server.base_url()))
        .send()
        .await
...
async fn test_get_text_file_content() {
    ...
    let response = client.get(&format!("{}/api/repos/test_user/test_repo/file/main/test.txt", server.base_url()))
        .send()
        .await
...
async fn test_get_csv_file_content() {
    ...
    let response = client.get(&format!("{}/api/repos/test_user/test_repo/file/main/data.csv", server.base_url()))
        .send()
        .await

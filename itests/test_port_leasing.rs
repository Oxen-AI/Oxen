...
async fn test_port_management_demo() {
    ...
    println!("📋 Leased ports: {}, {}, {}", lease1.port(), lease2.port(), lease3.port());
    ...
    println!("📤 Port returned, {} ports still allocated", allocated_after_drop.len());
...
async fn test_multiple_concurrent_servers() {
    ...
    println!("🎉 All {} servers started successfully on unique ports!", results.len());
}
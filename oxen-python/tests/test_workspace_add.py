...
def test_workspace_add_files_preserve_paths_absolute(
...
def test_workspace_add_files_preserve_paths_relative(
    celeba_remote_repo_one_image_pushed, shared_datadir
):
    _, remote_repo = celeba_remote_repo_one_image_pushed
    _assert_ws_add_files(
...
def test_workspace_add_files_rejects_bad_paths(
    celeba_remote_repo_one_image_pushed, shared_datadir
):
    _, remote_repo = celeba_remote_repo_one_image_pushed
    ...
    invalid_paths = [
        "not_real",
        "not_here/or/there/nor/over/where",
        "oh_this_will_be_fun/not",
    ]

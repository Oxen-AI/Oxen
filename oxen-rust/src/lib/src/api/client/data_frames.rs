...
mod tests {
    ...
    async fn test_fetch_schema_metadata() -> Result<(), OxenError> {
        crate::test::run_empty_local_repo_test_async(|mut local_repo| async move {
            ...
            let from_file = crate::test::test_200k_csv();
    ...
    async fn test_remote_parquet_no_params() -> Result<(), OxenError> {
        crate::test::run_empty_local_repo_test_async(|mut local_repo| async move {
            ...
            let from_file = crate::test::test_1k_parquet();
    ...
    async fn test_from_directory_with_images_sets_metadata() -> Result<(), OxenError> {
        crate::test::run_empty_local_repo_test_async(|mut local_repo| async move {
            ...
            util::fs::copy(crate::test::test_img_file_with_name("cat_1.jpg"), &image1)?;
            util::fs::copy(
                crate::test::test_img_file_with_name("cat_rgba.png"),
                &image2,
            )?;
            util::fs::copy(crate::test::test_img_file_with_name("dog_1.jpg"), &image3)?;

...
mod tests {
    ...
    async fn test_download_file_large() -> Result<(), OxenError> {
        #[rustfmt::skip]
        crate::test::run_select_data_sync_remote("large_files", |local_repo, remote_repo| async move {
    ...
    async fn test_download_file_large_to_dir_does_exist() -> Result<(), OxenError> {
        crate::test::run_select_data_sync_remote(
            "large_files",
    ...
    async fn test_get_root_entry_metadata() -> Result<(), OxenError> {
        crate::test::run_one_commit_sync_repo_test(|_local_repo, remote_repo| async move {
            let entry =

...
mod tests {
    ...
    async fn test_remote_ls_return_data_types() -> Result<(), OxenError> {
        crate::test::run_empty_local_repo_test_async(|mut repo| async move {
            ...
            let video_path = crate::test::test_video_file_with_name("basketball.mp4");
            let markdown_path = crate::test::test_text_file_with_name("README.md");
            let text_path = crate::test::test_text_file_with_name("hello.txt");

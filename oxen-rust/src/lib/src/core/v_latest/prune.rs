...
mod tests {
    ...
    async fn test_prune_with_commits() -> Result<(), OxenError> {
        oxen_test::run_training_data_repo_test_no_commits_async(|repo| async move {
            ...
            oxen_test::add_txt_file_to_dir(&train_dir, "file1.txt")?;
            oxen_test::add_txt_file_to_dir(&train_dir, "file2.txt")?;
    ...
    async fn test_prune_deleted_branch_commits() -> Result<(), OxenError> {
        oxen_test::run_training_data_repo_test_no_commits_async(|repo| async move {
            // Initial commit
            let train_dir = repo.path.join("train");
            let initial_file = oxen_test::add_txt_file_to_dir(&train_dir, "file1.txt")?;
            ...
            let branch_1_file = oxen_test::add_txt_file_to_dir(&train_dir, "file2.txt")?;
            ...
            let branch_2_file = oxen_test::add_txt_file_to_dir(&train_dir, "file3.txt")?;

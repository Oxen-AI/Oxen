...
mod tests {
    ...
    async fn test_command_merge_does_not_overwrite_modified_file() -> Result<(), OxenError> {
        crate::test::run_empty_local_repo_test_async(|repo| async move {
            ...
            let hello_file = crate::test::modify_txt_file(hello_file, "Hello from branch")?;
            repositories::add(&repo, &hello_file).await?;
            ...
            let hello_file = crate::test::modify_txt_file(hello_file, "Hello from main")?;
    ...
    async fn test_command_checkout_modified_file() -> Result<(), OxenError> {
        crate::test::run_empty_local_repo_test_async(|repo| async move {
            ...
            // Modify the file
            let hello_file = crate::test::modify_txt_file(hello_file, "World")?;
    ...
    async fn test_command_checkout_modified_file_in_subdirectory() -> Result<(), OxenError> {
        crate::test::run_select_data_repo_test_no_commits_async("annotations", |repo| async move {
            ...
            let one_shot_path = crate::test::modify_txt_file(one_shot_path, file_contents)?;
            let status = repositories::status(&repo)?;
    ...
    async fn test_checkout_local_does_not_remove_untracked_files() -> Result<(), OxenError> {
        ...
        crate::test::run_one_commit_sync_repo_test(|_, remote_repo| async move {
            ...
            crate::test::run_empty_dir_test_async(|user_a_repo_dir| async move {
                ...
                crate::test::write_txt_file_to_path(&file_1, "this is file 1")?;
                crate::test::write_txt_file_to_path(&file_in_dir_1, "this is file in dir 1")?;
                crate::test::write_txt_file_to_path(&file_in_dir_2, "this is file in dir 2")?;
                crate::test::write_txt_file_to_path(&file_in_subdir_2, "this is file in subdir 2")?;

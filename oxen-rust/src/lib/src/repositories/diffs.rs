...
mod tests {
    ...
    async fn test_diff_entries_add_multiple() -> Result<(), OxenError> {
        crate::test::run_bounding_box_csv_repo_test_fully_committed_async(|repo| async move {
            // get og commit
            ...
            crate::test::write_txt_file_to_path(&hello_file, "Hello")?;
            crate::test::write_txt_file_to_path(&world_file, "World")?;
    ...
    async fn test_diff_entries_modify_one_tabular() -> Result<(), OxenError> {
        crate::test::run_bounding_box_csv_repo_test_fully_committed_async(|repo| async move {
            ...
            // Remove a row
            let bbox_file = crate::test::modify_txt_file(
                bbox_file,
                r"
...
",
    ...
    async fn test_diff_entries_in_dir_at_root() -> Result<(), OxenError> {
        crate::test::run_bounding_box_csv_repo_test_fully_committed_async(|repo| async move {
            ...
            crate::test::write_txt_file_to_path(&new_root_file, "Hello,world")?;
            crate::test::write_txt_file_to_path(&new_bbox_file, "Hello,world")?;
            crate::test::write_txt_file_to_path(
                repo.path.join(add_dir_added_file),
                "Hello,world!!",
            )?;
            crate::test::write_txt_file_to_path(

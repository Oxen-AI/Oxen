        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let file_path =
                        oxen_test::add_txt_file_to_dir(&cloned_repo.path, "new file contents")?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    oxen_test::modify_txt_file(&full_path, file_contents)?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let sub_file_1 = oxen_test::add_txt_file_to_dir(&sub_dir, "Hello")?;
                    let sub_file_2 = oxen_test::add_txt_file_to_dir(&sub_dir, "World")?;
                    let sub_file_3 = oxen_test::add_txt_file_to_dir(&sub_dir, "!")?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let _file_1 = oxen_test::add_txt_file_to_dir(&repo_dir, "Hello")?;
                    let _file_2 = oxen_test::add_txt_file_to_dir(&repo_dir, "World")?;
                    let _file_3 = oxen_test::add_txt_file_to_dir(&repo_dir, "!")?;
                    ...
                    let _sub_file_1 = oxen_test::add_txt_file_to_dir(&sub_dir, "Hello")?;
                    let _sub_file_2 = oxen_test::add_txt_file_to_dir(&sub_dir, "World")?;
                    let _sub_file_3 = oxen_test::add_txt_file_to_dir(&sub_dir, "!")?;
                    ...
                    oxen_test::write_txt_file_to_path(&full_path, &file_content)?;
                    ...
                    oxen_test::write_txt_file_to_path(&excluded_full_path, &excluded_content)?;
                    ...
                    oxen_test::write_txt_file_to_path(&embedded_full_path, &embedded_content)?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let _ = oxen_test::add_txt_file_to_dir(&new_dir, "text 1")?;
                    let _ = oxen_test::add_txt_file_to_dir(&train_dir, "text 2")?;
                    let _ = oxen_test::add_txt_file_to_dir(&train_dir, "text 3")?;
                    let _ = oxen_test::add_txt_file_to_dir(&test_dir, "text 4")?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let hello_file_path = oxen_test::add_txt_file_to_dir(&dir_path, "hello.txt")?;

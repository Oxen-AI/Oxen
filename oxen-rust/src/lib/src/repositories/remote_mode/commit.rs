        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    oxen_test::modify_txt_file(&full_path, new_contents)?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    oxen_test::write_txt_file_to_path(&full_path, "Hello World")?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let _ = oxen_test::add_txt_file_to_dir(&full_dir_path, "file1.txt")?;
                    let _ = oxen_test::add_txt_file_to_dir(&full_dir_path, "file2.txt")?;

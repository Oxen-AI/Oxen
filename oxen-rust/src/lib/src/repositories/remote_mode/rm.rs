        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    let _ = oxen_test::add_txt_file_to_dir(&full_path, "new_file.txt")?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    oxen_test::write_txt_file_to_path(&full_path, "Test content")?;
        ...
        oxen_test::run_remote_repo_test_bounding_box_csv_pushed(
            |_local_repo, remote_repo| async move {
                ...
                oxen_test::run_empty_dir_test_async(|dir| async move {
                    ...
                    oxen_test::write_txt_file_to_path(cloned_repo.path.join(&file1), "dog")?;
                    oxen_test::write_txt_file_to_path(cloned_repo.path.join(&file2), "dog")?;
                    oxen_test::write_txt_file_to_path(cloned_repo.path.join(&file3), "cat")?;

...
mod tests {
    ...
    */
    ...
    async fn test_add_and_rm_file_in_dir() -> Result<(), OxenError> {
        oxen_test::run_select_data_repo_test_no_commits_async("README", |repo| async move {
    ...
    async fn test_staged_rm_file() -> Result<(), OxenError> {
        oxen_test::run_select_data_repo_test_committed_async("README", |repo| async move {
            // Remove the readme
            let path = Path::new("README.md");
    ...
    async fn test_rm_dir_with_modifications_should_throw_error() -> Result<(), OxenError> {
        ...
        oxen_test::run_select_data_repo_test_committed_async("train", |repo| async move {
            // Remove the train dir
            let train_dir = Path::new("train");
    ...
    async fn test_rm_subdir() -> Result<(), OxenError> {
        oxen_test::run_select_data_repo_test_committed_async("annotations", |repo| async move {

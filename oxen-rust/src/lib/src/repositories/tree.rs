...
mod tests {
    ...
    async fn test_merkle_two_files_same_hash() -> Result<(), OxenError> {
        crate::test::run_empty_local_repo_test_async(|local_repo| async move {
            ...
            crate::test::write_txt_file_to_path(&path_1, common_contents)?;
            crate::test::write_txt_file_to_path(&path_2, common_contents)?;
    ...
    async fn test_get_node_hashes_between_commits() -> Result<(), OxenError> {
        crate::test::run_local_repo_training_data_committed_async(|repo| async move {
